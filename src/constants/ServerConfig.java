...
public class ServerConfig {
  ...
  private static List<Integer> ignoreList = Collections.unmodifiableList(Arrays.asList(
  ...
  private static List<Integer> ignoreList_Send = Collections.unmodifiableList(Arrays.asList(
