...
public class MapleOxQuizFactory {
  ...
  public static String getOXQuestion(int imgdir, int id) {
    String ret = questions.get(new Pair(Integer.valueOf(imgdir), Integer.valueOf(id)))[0];
    if (ret == null) {
  ...
  public static int getOXAnswer(int imgdir, int id) {
    return Integer.parseInt(questions.get(new Pair(Integer.valueOf(imgdir), Integer.valueOf(id)))[1]);
  }

  public static String getOXExplain(int imgdir, int id) {
    return questions.get(new Pair(Integer.valueOf(imgdir), Integer.valueOf(id)))[2];
  }
}
