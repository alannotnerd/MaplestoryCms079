...
public class MapleItemInformationProvider {
  ...
  public int getScriptedItemNpc(int itemId) {
    if (this.scriptedItemCache.containsKey(Integer.valueOf(itemId))) {
      return this.scriptedItemCache.get(Integer.valueOf(itemId)).intValue();
    }
  ...
  public short getSlotMax(MapleClient c, int itemId) {
    if (this.slotMaxCache.containsKey(Integer.valueOf(itemId))) {
      return this.slotMaxCache.get(Integer.valueOf(itemId)).shortValue();
    }
    short ret = 0;
    MapleData item = getItemData(itemId);
    if (item != null) {
  ...
  public int getMeso(int itemId) {
    if (this.getMesoCache.containsKey(Integer.valueOf(itemId))) {
      return this.getMesoCache.get(Integer.valueOf(itemId)).intValue();
    }
    MapleData item = getItemData(itemId);
    if (item == null) {
      return -1;
  ...
  public int getWholePrice(int itemId) {
    if (this.wholePriceCache.containsKey(Integer.valueOf(itemId))) {
      return this.wholePriceCache.get(Integer.valueOf(itemId)).intValue();
    }
    MapleData item = getItemData(itemId);
    if (item == null) {
      return -1;
  ...
  public String getType(int itemId) {
    if (this.itemTypeCache.containsKey(Integer.valueOf(itemId))) {
      return this.itemTypeCache.get(Integer.valueOf(itemId));
    }
    MapleData item = getItemData(itemId);
    if (item == null) {
      return "";
  ...
  public double getPrice(int itemId) {
    if (this.priceCache.containsKey(Integer.valueOf(itemId))) {
      return this.priceCache.get(Integer.valueOf(itemId)).doubleValue();
    }
    MapleData item = getItemData(itemId);
    if (item == null) {
      return -1.0D;
  ...
  public boolean isCash(int itemId) {
    Integer req = getEquipStats(itemId).get("cash");

    return (req != null) && (req.intValue() != 0);
  }

  public boolean 不可交易A(int itemId) {
    Integer req = getEquipStats(itemId).get("tradeBlock");
    return (req != null) && (req.intValue() != 0);
  }

  public boolean 不可交易B(int itemId) {
    Integer req = getEquipStats(itemId).get("notSale");
    return (req != null) && (req.intValue() != 0);
  }

  public boolean 固有道具(int itemId) {
    Integer req = getEquipStats(itemId).get("only");
    return (req != null) && (req.intValue() != 0);
  }

  public List<Integer> getScrollReqs(int itemId) {
    if (this.scrollRestrictionCache.containsKey(Integer.valueOf(itemId))) {
      return this.scrollRestrictionCache.get(Integer.valueOf(itemId));
    }
  ...
  public List<SummonEntry> getSummonMobs(int itemId) {
    if (this.summonEntryCache.containsKey(Integer.valueOf(itemId))) {
      return this.summonEntryCache.get(Integer.valueOf(itemId));
    }
    MapleData data = getItemData(itemId);
  ...
  public int getExpCache(int itemId) {
    if (this.getExpCache.containsKey(Integer.valueOf(itemId))) {
      return this.getExpCache.get(Integer.valueOf(itemId)).intValue();
    }
    MapleData item = getItemData(itemId);
    if (item == null) {
      return 0;
  ...
  public int getWatkForProjectile(int itemId) {
    Integer atk = this.projectileWatkCache.get(Integer.valueOf(itemId));
    if (atk != null) {
      return atk.intValue();
    }
    MapleData data = getItemData(itemId);
  ...
  public String getName(int itemId) {
    if (this.nameCache.containsKey(Integer.valueOf(itemId))) {
      return this.nameCache.get(Integer.valueOf(itemId));
    }
  ...
  public String getDesc(int itemId) {
    if (this.descCache.containsKey(Integer.valueOf(itemId))) {
      return this.descCache.get(Integer.valueOf(itemId));
    }
    MapleData strings = getStringData(itemId);
    if (strings == null) {
      return null;
  ...
  public String getMsg(int itemId) {
    if (this.msgCache.containsKey(Integer.valueOf(itemId))) {
      return this.msgCache.get(Integer.valueOf(itemId));
    }
    MapleData strings = getStringData(itemId);
    if (strings == null) {
      return null;
  ...
  public boolean isDropRestricted(int itemId) {
    if (this.dropRestrictionCache.containsKey(Integer.valueOf(itemId))) {
      return this.dropRestrictionCache.get(Integer.valueOf(itemId)).booleanValue();
    }
    MapleData data = getItemData(itemId);
  ...
  public boolean isPickupRestricted(int itemId) {
    if (this.pickupRestrictionCache.containsKey(Integer.valueOf(itemId))) {
      return this.pickupRestrictionCache.get(Integer.valueOf(itemId)).booleanValue();
    }
    MapleData data = getItemData(itemId);
  ...
  public boolean isQuestItem(int itemId) {
    if (this.isQuestItemCache.containsKey(Integer.valueOf(itemId))) {
      return this.isQuestItemCache.get(Integer.valueOf(itemId)).booleanValue();
    }
    MapleData data = getItemData(itemId);
  ...
  public boolean isConsumeOnPickup(int itemId) {
    ...
    if (this.consumeOnPickupCache.containsKey(Integer.valueOf(itemId))) {
      return this.consumeOnPickupCache.get(Integer.valueOf(itemId)).booleanValue();
    }
  ...
  public int getCardMobId(int id) {
    return this.monsterBookID.get(Integer.valueOf(id)).intValue();
  }
