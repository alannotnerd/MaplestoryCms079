...
import net.sf.cherry.server.maps.*;
      ...
      for (int j = 0; j < ret.numDamage; j++) {
        ...
        if ((ret.skill != 14101006) && (damage == 199999)) {
          ...
          if ((c.getJob().getId() >= 0 && c.getJob().getId() <= 132) && (damage > 199998)) {//战士
            damage = (int) ((double) c.getStr() + c.getLevel() * 30 + (c.getDex() / (2 + (0.5D)))) * 15 + (力量 * 30) + (敏捷 * 10) + (运气 * 10) + (智力 * 10) + (攻击力 * 85) + (戒指全属性 * 20) + (戒指攻击力 * 10) + (int) (Math.random() * 10000.0D);
          }
          if ((c.getJob().getId() >= 200 && c.getJob().getId() <= 232) && (damage > 199998)) {//法师
            damage = (int) ((double) c.getInt() + c.getLevel() * 50 + (c.getInt() / (2 + (0.5D)))) * 15 + (力量 * 10) + (敏捷 * 10) + (运气 * 10) + (智力 * 50) + (攻击力 * 100) + (戒指全属性 * 50) + (戒指攻击力 * 30) + (int) (Math.random() * 10000.0D);
          }
          if ((c.getJob().getId() >= 300 && c.getJob().getId() <= 322) && (damage > 199998)) {//弓
            damage = (int) ((double) c.getDex() + c.getLevel() * 30 + (c.getStr() / (2 + (0.5D)))) * 15 + (力量 * 10) + (敏捷 * 25) + (运气 * 10) + (智力 * 10) + (攻击力 * 70) + (戒指全属性 * 10) + (戒指攻击力 * 20) + (int) (Math.random() * 10000.0D);//
          }
          if ((c.getJob().getId() >= 400 && c.getJob().getId() <= 422) && (damage > 199998)) {//飞侠
            damage = (int) ((double) c.getLuk() + c.getLevel() * 30 + (c.getDex() / (2 + (0.5D)))) * 15 + (力量 * 10) + (敏捷 * 10) + (运气 * 30) + (智力 * 10) + (攻击力 * 70) + (戒指全属性 * 10) + (戒指攻击力 * 20) + (int) (Math.random() * 10000.0D);//
          }
          if ((c.getJob().getId() >= 510 && c.getJob().getId() <= 512) && (damage > 199998)) {//海盗
            damage = (int) ((double) c.getStr() + c.getLevel() * 30 + (c.getDex() / (2 + (0.5D)))) * 15 + (力量 * 30) + (敏捷 * 10) + (运气 * 10) + (智力 * 10) + (攻击力 * 60) + (戒指全属性 * 10) + (戒指攻击力 * 10) + (int) (Math.random() * 10000.0D);
          }
          if ((c.getJob().getId() >= 520 && c.getJob().getId() <= 522) && (damage > 199998)) {//海盗/射手
            damage = (int) ((double) c.getStr() + c.getLevel() * 30 + (c.getDex() / (2 + (0.5D)))) * 15 + (力量 * 10) + (敏捷 * 25) + (运气 * 10) + (智力 * 10) + (攻击力 * 60) + (戒指全属性 * 10) + (戒指攻击力 * 15) + (int) (Math.random() * 10000.0D);
          }
