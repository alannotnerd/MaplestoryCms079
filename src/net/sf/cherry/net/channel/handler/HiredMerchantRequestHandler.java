...
public class HiredMerchantRequestHandler extends AbstractMaplePacketHandler {
  public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
    ...
    if (c.getPlayer().getMap().getMapObjectsInRange(c.getPlayer().getPosition(), 23000.0D, Arrays.asList(MapleMapObjectType.HIRED_MERCHANT, MapleMapObjectType.SHOP)).size() == 0) {
