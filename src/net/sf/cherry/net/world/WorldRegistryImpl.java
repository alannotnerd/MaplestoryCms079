...
public class WorldRegistryImpl extends UnicastRemoteObject
    ...
    try {
      ...
      if (rs.next()) {
        ...
        if (channelId < 1) {
          ...
          ChannelWorldInterface oldch = this.channelServer.get(Integer.valueOf(channelId));
          try {
            oldch.shutdown(0);
  ...
  public MapleParty getParty(int partyid) {
    return this.parties.get(Integer.valueOf(partyid));
  }

  public MapleParty disbandParty(int partyid) {
    return this.parties.remove(Integer.valueOf(partyid));
  }
  ...
  public MapleGuild getGuild(int id, MapleGuildCharacter mgc) {
    synchronized (this.guilds) {
      if (this.guilds.get(Integer.valueOf(id)) != null) {
        return this.guilds.get(Integer.valueOf(id));
      }
      if (id > 0) {
  ...
  public int addGuildMember(MapleGuildCharacter mgc) {
    MapleGuild g = this.guilds.get(Integer.valueOf(mgc.getGuildId()));
    if (g != null) {
  ...
  public void guildChat(int gid, String name, int cid, String msg) {
    MapleGuild g = this.guilds.get(Integer.valueOf(gid));
    if (g != null)
  ...
  public void expelMember(MapleGuildCharacter initiator, String name, int cid) {
    MapleGuild g = this.guilds.get(Integer.valueOf(initiator.getGuildId()));
    if (g != null)
  ...
  public boolean setGuildAllianceId(int gId, int aId) {
    MapleGuild guild = this.guilds.get(Integer.valueOf(gId));
    if (guild != null) {
  ...
  public MapleMessenger getMessenger(int messengerid) {
    return this.messengers.get(Integer.valueOf(messengerid));
  }
  ...
  public MapleAlliance getAlliance(int id) {
    synchronized (this.alliances) {
      if (this.alliances.containsKey(Integer.valueOf(id))) {
        return this.alliances.get(Integer.valueOf(id));
      }
      return null;
    }
  }
  ...
  public void disbandAlliance(int id) {
    synchronized (this.alliances) {
      MapleAlliance alliance = this.alliances.get(Integer.valueOf(id));
      if (alliance != null) {
        for (Integer gid : alliance.getGuilds()) {
          MapleGuild guild = this.guilds.get(gid);
  ...
  public boolean addGuildtoAlliance(int aId, int guildId) {
    MapleAlliance alliance = this.alliances.get(Integer.valueOf(aId));
    if (alliance != null) {
