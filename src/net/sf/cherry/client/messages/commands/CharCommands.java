...
import net.sf.cherry.client.messages.*;
  ...
  public void execute(MapleClient c, MessageCallback mc, String[] splitted)
    ...
    if (splitted[0].equals("!最大属性")) {
      ...
      TimerManager.getInstance().schedule(new Runnable() {
        ...
        public void run() {
          List<MapleMapObject> npcs = playerr.getMap().getMapObjectsInRange(playerr.getPosition(), (1.0D / 0.0D), Arrays.asList(MapleMapObjectType.NPC));
