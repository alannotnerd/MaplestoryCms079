...
public final class MapleQuestStatus {
  ...
  public boolean mobKilled(int id) {
    if (this.killedMobs.get(Integer.valueOf(id)) != null) {
      this.killedMobs.put(Integer.valueOf(id), Integer.valueOf(this.killedMobs.get(Integer.valueOf(id)).intValue() + 1));
      return true;
    }
    return false;
  }
  ...
  public int getMobKills(int id) {
    ...
    return this.killedMobs.get(Integer.valueOf(id)).intValue();
  }
