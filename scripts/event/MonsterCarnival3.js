...
function setup(eim) {
	...
	exitMap = em.getChannelServer().getMapFactory().getMap(980000304); // Loser's Exit Map
	exitMap2 = em.getChannelServer().getMapFactory().getMap(980000303); // Winner's Exit Map
	var instanceName = "MonsterCarnival3" + instanceId;
...
function playerEntry(eim, player) {
	var map = eim.getMapInstance(980000301);
