...
function start() {
	...
	var kingClang = net.sf.cherry.server.life.MapleLifeFactory.getMonster(5220001);
	if (hotSand.countMobOnMap(5220001) == 0 && hotSand.countMobOnMap(5220000) == 0) {
		...
		hotSand.broadcastMessage(net.sf.cherry.tools.MaplePacketCreator.serverNotice(6, "[Event] A large, blue shell seems to have been washed up onto the beach..."));
	}
	scheduleNew();
}
