...
function playerEntry(eim, player) {
	...
	player.getClient().getSession().write(net.sf.cherry.tools.MaplePacketCreator.getNPCTalk(2013001, /*(byte)*/ 0, texttt, "00 00"));
	//player.getClient().getSession().write(net.sf.cherry.scripting.npc.NPCScriptManager.dispose(eim.getClient()));
	//THE CLOCK IS SHIT
...
function clearPQ(eim) {
	...
	var iter = eim.getPlayers().iterator();
        ...
        player.getClient().getSession().write(net.sf.cherry.tools.MaplePacketCreator.getClock(60));
		}
