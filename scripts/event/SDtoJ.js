...
var returnTo = new Array(130000210,101000400);
var rideTo = new Array(101000400,130000210);
var birdRide = new Array(200090057,200090310);
var myRide;
var returnMap;
var map;
var docked;
...
function timeOut() {
	var iter = em.getInstance("SDtoJ").getPlayers().iterator();
	while (iter.hasNext()) {
		var player = iter.next();
		player.changeMap(docked, docked.getPortal(0));
		em.getInstance("SDtoJ").unregisterPlayer(player);
	}
	em.setProperty("isRiding","false");
	em.disposeInstance("SDtoJ");
}
