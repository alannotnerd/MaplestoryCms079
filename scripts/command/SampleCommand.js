...
function execute (c, mc, splitted) {
	if (splitted.length != 2) {
		mc.dropMessage("Syntax: !shop <shopid>, where shopid can be numerical or the following shops xuyi:");
		mc.dropMessage("mapleitems, glimmer, miscitems, scrolling, summonbags, warrior, magician, thief, bowman, nxrings, nxeffects, nxpackages, itembuffs, smega");
