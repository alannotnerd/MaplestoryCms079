...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#L1##r" + 蓝色箭头 + "挑战猎魔人#g>>>>>>>>#b#v4001009#出处\r\n\r\n"//3
            text += "#L2##r" + 蓝色箭头 + "挑战血焰将军#g>>>>>>#b#v4001012#出处\r\n\r\n"//3
...
cm.喇叭(2, "[" + cm.getPlayer().getName() + "]成功开始挑战绯红BOSS副本，召唤出一只【猎魔人】！！");
			   cm.dispose();
		   }else{
			...
			if(cm.haveItem(4031497,1)){ //物品条件
			    ...
			    cm.spawnMobOnMap(9400591,1,1940,276,803001200);
		            //cm.summonMobter(9400633, 1);
                            //cm.summonMob(9400633,180000,5250,1);
cm.喇叭(2, "[" + cm.getPlayer().getName() + "]成功开始挑战绯红BOSS副本，召唤出一只【血焰将军】！！");
			   cm.dispose();
		   }else{
			   cm.sendOk("需要搜集#b1个 #v4031497#");
			   cm.dispose();
