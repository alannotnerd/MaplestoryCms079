...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendNext("嗨，我是 #b转职官#k 我可以帮助你快速转职哦~~！");
        } else if (status == 1) {
...
//          }
            ...
            if (cm.getJob().equals(net.sf.cherry.client.MapleJob.ASSASSIN)) {
                ...
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer() + "] ：★★★转职成功！大家祝贺ta★★★ ");
            } else if (cm.getJob().equals(net.sf.cherry.client.MapleJob.FIGHTER)) {
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer() + "] ：★★★转职成功！大家祝贺ta★★★ ");
            } else if (cm.getJob().equals(net.sf.cherry.client.MapleJob.PAGE)) {
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer() + "] ：★★★转职成功！大家祝贺ta★★★ ");
           ...
           cm.dispose();
            ...
            cm.sendOk("转职成功！加油锻炼，当你变的强大的时候记的来找我哦！\r\n\r\n#r打Boss爆书学习的技能: #s4221003# #s4121003#");
             cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer() + "] ：★★★转职成功！大家祝贺ta★★★ ");
            ...
            cm.sendOk("转职成功！加油锻炼，当你变的强大的时候记的来找我哦！\r\n\r\n#r打Boss爆书学习的技能: #s2321007# #s2121004#");
            cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer() + "] ：★★★转职成功！大家祝贺ta★★★ ");
            ...
            cm.sendOk("转职成功！加油锻炼，当你变的强大的时候记的来找我哦！\r\n\r\n#r打Boss爆书学习的技能: #s1120003# #s1221007#");
            cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer() + "] ：★★★转职成功！大家祝贺ta★★★ ");
            ...
            cm.sendOk("转职成功！加油锻炼，当你变的强大的时候记的来找我哦！\r\n\r\n#r打Boss爆书学习的技能: #s1221007# #s1220010#");
            cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer() + "] ：★★★转职成功！大家祝贺ta★★★ ");
	    ...
	    cm.teachSkill(1321007,0,10);
            ...
            cm.sendYesNo("不错的选择哦，确定要成为一名 #b[" + jobName + "] #k吗？"); 
                ...
                cm.changeJob(job);
                cm.sendOk("转职成功！加油锻炼，当你变的强大的时候记的来找我哦！");
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer() + "] 在NPC：快速转职 快速转职成功！");
                cm.dispose();
            ...
            cm.teachSkill(1004,1,1);
                ...
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer() + "] 在NPC：快速转职 快速转职为骑士团职业！");
                cm.sendOk("转职成功！加油锻炼，当你变的强大的时候记的来找我哦！");
            } else if(parseInt(cm.getJob().getId() / 100) >10 && cm.getLevel()>=30 && cm.getJob().getId()%100 == 0){
            ...
            if(cm.getJob().getId() == 2000 && cm.getLevel() >=10){
                ...
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer() + "] ：★★★1次转职成功！大家祝贺ta★★★ ");
                cm.sendOk("转职成功！加油锻炼，当你变的强大的时候记的来找我哦！");
            } else if(cm.getJob().getId() == 2100 && cm.getLevel() >=30){
                ...
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer() + "] ：★★★2次转职成功！大家祝贺ta★★★ ");
                cm.sendOk("转职成功！加油锻炼，当你变的强大的时候记的来找我哦！");
            } else if(cm.getJob().getId() == 2110 && cm.getLevel() >=70){
            ...
            cm.teachSkill(1004,1,1);
                ...
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer() + "] ：★★★4次转职成功！大家祝贺ta★★★ ");
                cm.sendOk("转职成功！希望您以后的冒险之路顺利！\r\n\r\n#r打Boss爆书学习的技能: #s21120005# #s21120004# #s21120006#");
            }
            cm.dispose();
        } else {
            cm.dispose();
