...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#e#d制作#v1412161#需要#v4011007#x1.#v4021009#x1.#v4000235#x5.#v4000243#x5.#v4031891#500万.搜集好道具我就可以为您制作了.#l\r\n\r\n"//3
            text += "#L1##r制作扎昆泊伊兹尼武器\r\n\r\n"//3
            cm.sendSimple(text);
        } else if (selection == 1) {
			//1
            ...
            cm.dispose();
				...
				cm.gainMeso(-5000000);
            cm.sendOk("制作成功！");
			cm.worldMessage(6,"玩家：["+cm.getName()+"]制作了[扎昆泊伊兹尼双手战斧]，带上你的武器去狩猎吧！");
            cm.dispose();
			}else{
            cm.sendOk("您的材料不足！");
            cm.dispose();
