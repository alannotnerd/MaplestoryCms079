    ...
    if (status == 0) {
        ...
        if (cm.getPlayer().getClient().getChannel() == 1) {
            if (cm.getPlayer().getMapId() == 211070100) { //传送
                ...
                var rwpz = "";
                rwpz = "经验指数：#v4140301##v4140301##v4140301##v4140301##v4140301##v4140301##v4140301##v4140301#\r\n";
                rwpz += "#e推荐等级：150 - 250";
                rwpz += "        推荐人数：1 - 6  \r\n#b已进行普通模式：" + cm.getPQLog(PQ) + " 次       剩余挑战次数：" + pqtry + " 次#k";
                rwpz += "\r\n普通模式状态：" + vipstr + "        #n";
                var zyms = "";
                zyms = "#e#v3991051##v3991051##v3991051##v3991051#<Boss - 贝勒-德>#v3991050##v3991050##v3991050##v3991050##n\r\n#b#h0# \n\#k你现在想和队友一起挑战这个BOSS副本吗?\r\n" + rwpz + "\r\n";
