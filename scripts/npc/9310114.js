...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendYesNo("您真的打败了生化魔人欧啦啦么。  请务必获取欧啦啦掉落物 #r#t4001318##k，我会赠送您一份小礼物，请务必笑纳。");
    } else if (status == 1) {
	...
	cm.channelMessage(0x18, "『心动的公主』" + " : " + "[" + cm.getChar().getName() + "]获得了" + psrw[rand][1] + "个<" + ii.getName(psrw[rand][0]) + ">,快去挑战吧");
	   cm.dispose(); 
	}
		}
		}
